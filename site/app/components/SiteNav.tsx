  ...
  return (
    <nav className="sitenav">
      <div className="wrap row">
        <Link href="/" className="wordmark"><span className="chip" />Readout</Link>
        <div className="navlinks">
          ...
          <a className="gh-btn" href="https://github.com/Ay-obami/dreamdex-readout" target="_blank" rel="noopener noreferrer">GitHub</a>
        </div>
      </div>
    </nav>
  );
